	...
	public SampleViewFromReadDocFile(Frame parent,  Request tamplateRequest,  ArrayList<String> comBox_O_I_S, String ref_Date_Time, String period,
		...
		for (Sample sample : listSample) {
				...
				final int selection = i;
				{
					...
					{
						lbl_sample_code[i] = new JLabel(requestCode + "-" + sample.getSample_code());
					...
					}
					{
						...
						ImageIcon pic = new ImageIcon(getClass().getClassLoader().getResource(GlobalPathForIcons.get_destination_addIcon()));
...
//								}
					...
					}
					{
						...
						txtArea_Sample_Descr[i].setText(sample.getDescription_sample());
						if (notEmptryString)
...

					{
						...
						txtFld_Ref_date[i].setText(sample.getDate_time_reference());
						if (notEmptryString)
					...
					ImageIcon pic = new ImageIcon(getClass().getClassLoader().getResource(GlobalPathForIcons.get_destination_ModifyIcon()));
...
//						}
						...
						comboBox_Period[i].setSelectedItem(sample.getPeriod().getValue());
						if (notEmptryString)
...

					{
						...
						txtFld_Year[i].setText(sample.getGodina_period()+"");
						if (notEmptryString)
