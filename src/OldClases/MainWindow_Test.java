...
import MainWindow.ProgressBarView;
...
public class MainWindow_Test extends JFrame {
	...
	public MainWindow_Test(TranscluentWindow round) {
												...
												
	{
		...
		round.StopWindow();
		setVisible(true);
		ProgressBarView.ProgressBarView(btnNewButton, progressBar);
//		createLeftPalenInfo22( progressBar, lblNewLabel);
//		createLeftPalenInfo(under_panel_Left, progressBar, lblNewLabel);

	}
	

	private void createLeftPalenInfo22( JProgressBar progressBar, JLabel lblNewLabel) {
