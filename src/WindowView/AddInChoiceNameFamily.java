...
//				textField_Family.setAlignmentY(0.0f);
//				textField_Family.setAlignmentX(0.0f);
				...
				textField_Family.addKeyListener(new KeyListener() {
					...
					public void keyReleased(KeyEvent event) {
						...
						ArrayList<String> listFamily = getStrMasFamily(textField_Family.getText(), massiveO_I_R);
				...
				textField_Name.addKeyListener(new KeyListener() {
					...
					public void keyReleased(KeyEvent event) {
						...
						if (textField_Name.getText().length() >= 3) {
							...
							ArrayList<String> listName = getStrMas(textField_Name.getText(), massiveO_I_R);
		...
		public ArrayList<String> getStrMasFamily(String str, ArrayList<String> massiveO_I_R) {
String stringF;
			ArrayList<String> masStr = new ArrayList<String>();
			for (String string : massiveO_I_R) {
