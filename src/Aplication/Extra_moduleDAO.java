...
public class Extra_moduleDAO {
	...
	public static void setValueExtra_module(External_applicant external_applicant,
			Internal_applicant internal_applicant, DopalnIziskv otclonenie, Aplicant aplicant, Boolean return_samples,
			String additional_requirements, String additional_arrangements) {
	...
	public static int CheckExtra_module(Extra_module extra_module) {
		...
		for (Extra_module extraModule : list) {
			...
			if (extra_module.getExternal_applicant() != null && extraModule.getExternal_applicant() != null) {
				...
				if (extra_module.getExternal_applicant().getId_external_applicant() != extraModule
						.getExternal_applicant().getId_external_applicant()) {
					fl = false;
					System.out.println("External_applicant " + fl);
				}
			} else {
			...
			if (extra_module.getInternal_applicant() != null && extraModule.getInternal_applicant() != null) {
				...
				if (extra_module.getInternal_applicant().getId_internal_applicant() != extraModule
						.getInternal_applicant().getId_internal_applicant()) {
					fl = false;
