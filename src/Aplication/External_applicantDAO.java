...
public class External_applicantDAO {
	...
	public static void setValueExternal_applicant(String external_applicant_name, String external_applicant_address,
			String external_applicant_telephone, String external_applicant_contract_number) {
	...
	public static int setValueExternal_applicantWhithCheck(External_applicant valueEnt) {
		...
		for (External_applicant external_applicant : list) {
			if (external_applicant.getExternal_applicant_address().contains(valueEnt.getExternal_applicant_address())
					&& external_applicant.getExternal_applicant_contract_number()
							.contains(valueEnt.getExternal_applicant_contract_number())
					&& external_applicant.getExternal_applicant_name().contains(valueEnt.getExternal_applicant_name())
					&& external_applicant.getExternal_applicant_telephone()
							.contains(valueEnt.getExternal_applicant_telephone())) {
	...
	public static List<External_applicant> getInListAllExternalApplicant() {
		...
		Query query = entitymanager
				.createQuery("SELECT e FROM External_applicant e ORDER BY e.external_applicant_name ASC");
		...
		for (External_applicant e : list) {
			System.out.println("Num:" + ((External_applicant) e).getId_external_applicant()
					...
					+ ((External_applicant) e).getExternal_applicant_contract_number());
		}
