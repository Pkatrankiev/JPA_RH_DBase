...
public class Table_Request_List_Test2 extends JDialog {
	...
	public Table_Request_List_Test2(JFrame parent, TranscluentWindow round, Users user, String tipe_Table,
	...
	private void columnChoiceListener(Table_Request_List_Test2 table_Request_List, JScrollPane scrollPane,
				...
				if (changedVisibleColumn) {
					...
					final Thread thread = new Thread(new Runnable() {
						...
						public void run() {
							...
							JFrame f = new JFrame();
							new Table_Request_List_Test2(f, round, Login.getCurentUser(), tipe_Table, frame_name,false);
